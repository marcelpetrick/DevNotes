...
* alternative to cpgt: github co-pilot
* can help to detect flaws in your code, highlight it
![](img00.png)
...
![](img03.png)
![](img04.png)
* cgpt had always a lag in response, also needed sometimes several hints to get to the correct answer
* with cgpt this changed drastically
## how not to use it ..
* "bad code can be cleaned up, but it is very expensive." robert c. martin
![](img05.png)
...
![](img06.png)
+ don't build code which needs lots of context
![](img07.png)
* code needs to be readable for other developers
* take the error message, also add 2-3 lines of code to cgpt, then the result should give you some insight: but you can also influence it by "explain it to me like i am a child" or "like i am a software engineer" (haha)
![](img08.png)
...
![](img09.png)
* example: someone used cgpt to find vulnerabilities in their solana contract
![](img10.png)
* use it to explain technical concepts to you: for instance quantum computing ..
...
* generate regexes
* explain this technical concept to me in simple terms
