...
*  95% of applications used at least one open source component that was out of date by four or more years (or even abandoned)
...
* sniffer onto the docker; it was starting a service in the background, which was sending the logfiles somewhere else - this is terrifying. because you have no control over this
