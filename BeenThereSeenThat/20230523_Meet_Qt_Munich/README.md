...
* Linux and Windows on ARM is a regional thing, Asia
...
* simulate end user actions on the application and then verify if the app behaved like expected
* cross platform
...
* preferred python .. because of the 3rd party tools
* individual perspective: simulate user actions, verifying behaviour of the application, appearance of the application, increasing test accuracy, reducing human factor
