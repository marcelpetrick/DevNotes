...
* not loyality driven: 1 or 1k does not matter; your IP stays your IP, no impact on BOM
...
* EI is not alone: they are aware of the competititors, EI can be run in a docker container
...
* auto labelling tool:  first label minimum set, then sorting into buckets, then just retrain the model and use it to label the next data -> until everything is clustered into buckets; 
